...
export const translations = {
  th: {
    ...
    // Dashboard
    dash_active_trips: 'นัดหมายวันนี้',
    ...
    dash_in_progress: 'กำลังดำเนินงาน',
    dash_scheduled: 'นัดหมายไว้',
    dash_recent_history: 'ประวัติการเข้าพบ',
    dash_unconfirmed_badge: 'ยังไม่ครบ',
    dash_confirmed_badge: 'ครบทุกจุด',
    dash_pending_start_badge: 'รอดำเนินการ',
    dash_unconfirmed_tag: 'ยังไม่ครบ',
  ...
  en: {
    ...
    dash_completed_visits: 'Completed',
